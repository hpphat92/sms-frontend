...
@Component({
  selector: 'broadcast-program-scheduled',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'broadcast-program-scheduled.template.html',
  styleUrls: ['broadcast-program-scheduled.style.scss']
})
export class BroadcastProgramScheduledComponent implements OnInit, OnDestroy {
