...
@Component({
  ...
  template: `
    <div id="main" class="animate-slide-up" layout="column">
      ...
      if (event instanceof NavigationStart) {
        ...
        if (document.querySelector('perfect-scrollbar')) {
          if (storedRoutes && storedRoutes[keyPath]) {
            document.querySelector('perfect-scrollbar').scrollTop =
              storedRoutes[keyPath].scrollPosition || 0;
          } else {
            document.querySelector('perfect-scrollbar').scrollTop = 0;
          }
        }
