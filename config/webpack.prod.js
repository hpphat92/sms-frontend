...
const targetProfile = helpers.getProfile();
// const deployConfig = require('./deploy/index.js');
// let deployProfile = deployConfig(targetProfile);
...
const VARS = require('./vars')(targetProfile); // the project VARS
  ...
  return webpackMerge(commonConfig({
    ...
    module: {
      ...
      rules: [
         ...
         * some modules doesn't play well with ExtractTextPlugin so we ignore it from ExtractTextPlugin
         * https://github.com/AngularClass/angular2-webpack-starter/issues/1541
         */
        {
          test: /\.css$/,
          use: ['to-string-loader', 'css-loader'],
          include: [/ngx-perfect-scrollbar/]
        },
        {
          test: /\.scss$/,
          use: ['to-string-loader', 'css-loader', 'resolve-url-loader', 'sass-loader'],
          include: [/ngx-perfect-scrollbar/]
        },
